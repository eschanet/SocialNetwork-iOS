...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            UIImageView *avatarImageView = [[UIImageView alloc] init];
            avatarImageView.frame = CGRectMake( 12.0f, 10.0f, 20.0f, 20.0f);
            [avatarImageView setImage:[UIImage imageNamed:@"ButtonCamera"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
        }
        else {
            cell.textLabel.text = NSLocalizedString(@"Highscore", nil);
            UIImageView *avatarImageView = [[UIImageView alloc] init];
            avatarImageView.frame = CGRectMake( 12.0f, 10.0f, 20.0f, 20.0f);
            [avatarImageView setImage:[UIImage imageNamed:@"icon-trophy"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            [self postNotificationWithString:@"OpenMediaFeed"];
        }
        else {
            [self postNotificationWithString:@"OpenLikesFeed"];
        }
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 1) {
        ...
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, tableView.frame.size.width, 40.0)];
        titleLabel.text = [NSString stringWithFormat:NSLocalizedString(@"FEEDS", nil)];
