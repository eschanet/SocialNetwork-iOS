...
- (id)initWithFrame:(CGRect)frame buttons:(ESPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        ...
        [self.mentionLabel setTextColor:[UIColor colorWithRed:84.0f/255.0f green:84.0f/255.0f blue:84.0f/255.0f alpha:1.0f]];
        ...
        [self.mentionLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:12]];
