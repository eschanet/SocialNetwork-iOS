...
- (void)createView {
    ...
    if ([[self.photo objectForKey:@"type"] isEqualToString:@"text"]) {
        ...
        retweetLabel.font= [UIFont fontWithName:@"HelveticaNeue" size:10];
        ...
        self.OPName.font= [UIFont fontWithName:@"HelveticaNeue-Bold" size:15];
        ...
        self.OPmentionName.font= [UIFont fontWithName:@"HelveticaNeue" size:15];
    ...
    [self.photographer fetchIfNeededInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        ...
        [mentionLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:12]];
