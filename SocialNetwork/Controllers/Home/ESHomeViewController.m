...
@interface ESHomeViewController () <GADBannerViewDelegate>
...
- (void)useNotificationWithString:(NSNotification *)notification //use notification method and logic
{
    ...
    else if ([stringValueToUse isEqualToString:@"FindFriendsOpen"])
    {
        ...
        if ([MFMailComposeViewController canSendMail]) {
            ...
            [mailComposer setToRecipients:[NSArray arrayWithObjects: @"eric@codelight.lu",nil]];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (alertView.tag == 99) {
        if (buttonIndex == 0) {
            ...
            TOWebViewController *webViewController = [[TOWebViewController alloc] initWithURL:[NSURL URLWithString:@"http://codelight.lu/terms-network/"]];
